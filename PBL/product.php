...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="/Laptopku/PBL-login/crAkun.php" class="cartimg"><img src="img/chart-icon.png" alt="cart user"></a>
            <div class="login-btn">
  ...
  <div class="container">
    ...
    <form method="GET">
      ...
      <input type="text" name="search" placeholder="Search..." value="<?= htmlspecialchars($search) ?>" >
          ...
          <a href="product.php" class="btn btn-danger">Reset</a>
      </div>
    </form>
      ...
      <div class="container-produk2">
          ...
          <div class="product-card2">
              ...
              <div class="button-group2">
                  ...
                  <button class="details-btn2" onclick="window.location.href='detail.php?id=<?php echo $product['id_product']; ?>';">Get Details</button>
              </div>
          </div>
          <?php endforeach; ?>
    </div>
    ...
    <div id="noProductsModal" class="modal" style="display: none;">
        ...
        <div class="modal-icon">
            ...
            <button class="btn btn-ok" onclick="window.location.href='product.php'">OK</button>
        </div>
    </div>
