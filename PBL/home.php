...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="/Laptopku/PBL-login/crAkun.php" class="cartimg"><img src="img/chart-icon.png" alt="profile user"></a>
            <div class="login-btn">
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <a href="product.php"><i class="fa fa-arrow-right"></i></a>
            </div>
        </div>
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                ...
                <div class="button-group">
                    <button class="cart-btn" onclick="window.location.href='crAkun.html';">
                        <img src="img/chart-icon.png" alt="Cart">
                    </button>
                    <button class="details-btn" onclick="window.location.href='detail.html';">Get Details</button>
                </div>
            </div>
