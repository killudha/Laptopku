...
$query = "
    ...
    WHERE o.id_user = :id_user AND s.status_delivery = 'not paid' AND o.payment_status = 'not paid'
";
        ...
        <div class="main-content">
            ...
            <div class="status-container">
                <div class="status-item" onclick="window.location.href='pesanan.php';" style="cursor: pointer;">
                    ...
                    <p><span class="pay">Belum<br>Bayar</span></p>
                </div>
            ...
            <div class="order-card">
                ...
                <div class="btn-payment">
                    <button class="payment-button" onclick="window.location.href='payment.php?id_order=<?= $row['id_order'] ?>';">Bayar Sekarang</button>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
