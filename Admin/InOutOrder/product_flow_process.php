...
try {
    ...
    if (isset($_POST['type'], $_POST['id_product'], $_POST['date'], $_POST['quantity'])) {
        ...
        if ($quantity > 0) {
            ...
            if ($type == 'In') {
                // Query to save incoming product data
                $query = "INSERT INTO Masuk_Product (id_product, tanggal_masuk, kuantitas) 
                ...
                // Query to save outgoing product data
                $query = "INSERT INTO Keluar_Product (id_product, tanggal_keluar, kuantitas) 
                          VALUES (:id_product, :date, :quantity)";
